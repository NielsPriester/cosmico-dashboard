...
- 3.3.4: officieel Reddingsbrigade-oranje (#ff5a00) duidelijker zichtbaar; layout ongewijzigd.


## Kiosk animatie 3.3.4
...
- 3.3.4: kiosk focusanimatie vertraagd: circa 1,05 s rustig vergroten, circa 2 s volledig groot, circa 1,05 s rustig verkleinen, daarna 3 s rust.
